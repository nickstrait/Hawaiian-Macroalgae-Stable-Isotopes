...
```{r}
cols_to_keep = c('Depth', 'Location', 'Region', 'Zone', 'Division', 'Exact Depth')
...
```{r}
write.csv(N15.matrix, ".\\N15.matrix.csv")
write.csv(percent.matrix, ".\\percent.matrix.csv")
write.csv(factors.matrix, ".\\factors.matrix.csv")
```
