...
ggplot(NwestHI, aes(x=Zone, y=N15, fill=Location)) + geom_violin(trim = FALSE)

ggplot(NwestHI, aes(x=Zone, y=Percent, fill=Location)) + geom_violin(trim = FALSE)
```
...
ggplot(MHI.meso, aes(x=Division, y=N15, fill=Division)) + geom_violin(trim = FALSE)

ggplot(MHI.meso, aes(x=Division, y=Percent, fill=Genus)) + geom_violin(trim = FALSE)
...
ggplot(NWHI.shlw, aes(x=Division, y=N15, fill=Division)) + geom_violin(trim = FALSE)

ggplot(NWHI.shlw, aes(x=Division, y=Percent, fill=Genus)) + geom_violin(trim = FALSE)
...
```{r}
ggplot(NWHI.meso, aes(x=Division, y=N15, fill=Division)) + geom_violin(trim = FALSE)

ggplot(NWHI.meso, aes(x=Division, y=Percent, fill=Genus)) + geom_violin(trim = FALSE)

ggplot(NWHI.meso, aes(x=Location, y=N15, fill=Genus)) + geom_violin(trim = FALSE)
